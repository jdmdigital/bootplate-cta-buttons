...
1. Download the plugin from [GitHub](https://github.com/jdmdigital/bootplate-cta-buttons) (wordpress.org coming soon)
1. Install the plugin [using GitHub Updater](http://bootplate.jdmdigital.co/setup/install/)
...
1. Enter the text you want the button to say, for example: "Download Today"
1. Publish or Update the page

**NOTE**: That just sets the post meta for us to use our handy functions.  You still have to add the actual functions to show the information in your theme.  See a full example in the [GitHub README](https://github.com/jdmdigital/jdm-cta-buttons "JDM Labs") for details on how to display your new Call-to-Action button in your themes.

== Frequently Asked Questions ==

= Why isn't my CTA links showing up? =
You need to make sure you add the PHP code to your theme in the location you want it.  See a full example in the [GitHub README](https://github.com/jdmdigital/bootplate-cta-buttons/blob/master/README.md "JDM Labs") for details on how to display your new Call-to-Action button in your themes.
...
= 0.1 =
* Initial Release.
* Forked from [JDM Custom CTA](http://labs.jdmdigital.co/code/jdm-custom-cta/ "JDM Labs")
